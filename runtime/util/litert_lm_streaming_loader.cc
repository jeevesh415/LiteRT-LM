...
LitertLmStreamingLoader::GetNextSection() {
  ...
  // Create a copy of the SectionInfo. This copy will be returned,
  // allowing the caller to manage the lifetime of the substream.
  SectionInfo return_val = section_info;

  // Open the substream and assign it directly to the data_stream of the copy.
  ASSIGN_OR_RETURN(
      return_val.data_stream,
